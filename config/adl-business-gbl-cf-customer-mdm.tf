...
variable "rw_buckets" {
  type = list(string)
  default = [
    "adl-customer-mdm-etl/adl-trusted-gbl-cf-customer-mdm",
    "adl-customer-mdm-etl/adl-enriched-gbl-cf-customer-mdm",
    "adl-customer-mdm-etl/adl-raw-gbl-cf-customer-mdm"
  ]
}
...
locals {
  name             = "adl-business-gbl-cf-customer-mdm"
  description      = "adl-business-gbl-cf-customer-mdm"
  ...
  workflow_sm = [

    {
      ...
      flow = [
        {
          name            = "outbound_api_hcp" // Job name
          type            = "glueetl"      // [ glueetl || pythonshell || python3.7 ]
          glue_version    = "4.0"
          script_location = "adl-customer-mdm-etl/releases/${var.artifacts_version}/out_api_hcp.py"
