...
locals {
  name             = "adl-landing-gbl-cf-customer-mdm"
  description      = "adl-landing-gbl-cf-customer-mdm"
  ...
  workflow_sm = [

    {
      ...
      flow = [
        {
          name            = "sap-hcp-api" // Job name
          type            = "glueetl"      // [ glueetl || pythonshell || python3.7 ]
          glue_version    = "4.0"
          script_location = "adl-customer-mdm-etl/releases/${var.artifacts_version}/api_sap_hcp.py"
