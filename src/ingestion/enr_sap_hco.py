...
hcp_comb_trusted = "s3://adl-base-customer-md-9b69xa1sw6t9jtkd3azyi3rjois1huse1b-s3alias/trusted/FS_SAP_DC_CUST/HCP_CUST_ADDR_COMB/"
hcp_comb_enriched = "s3://adl-base-customer-md-zjgnb31idg7ozb8ttimo3zojpuffguse1b-s3alias/enriched/FS_SAP_DC_CUST/HCP_SAP_JSON/"
hco_comb_trusted = "s3://adl-base-customer-md-9b69xa1sw6t9jtkd3azyi3rjois1huse1b-s3alias/trusted/FS_SAP_DC_CUST/HCO_CUST_ADDR_COMB/"
hco_comb_enriched = "s3://adl-base-customer-md-zjgnb31idg7ozb8ttimo3zojpuffguse1b-s3alias/enriched/FS_SAP_DC_CUST/HCO_SAP_JSON/"

#hcp_comb_trusted = "s3a://mygenbuc/Paraquet/SAP_HCO_paraquet/SAP_HCP_ADDR_comb.parquet"
#hcp_comb_enriched = "s3a://mygenbuc/Paraquet/SAP_HCO_enriched/"
# hcp_comb_enriched = "/home/ec2-user/SAP_HCP_json"

#hco_comb_trusted = "s3a://mygenbuc/Paraquet/SAP_HCO_paraquet/SAP_HCO_ADDR_comb.parquet"
#hco_comb_enriched = "/home/ec2-user/SAP_HCO_json"
#hco_comb_enriched = "/home/ec2-user/krishna/HCO_010625"
...
try:
                ...
                struct(
                    struct(
                        ...
                        struct(
                            ...
                            array(
                                struct(
                                    lit("configuration/sources/FS_SAP_DC_CUST").alias("type"),
                        ...
                        struct(
                            ...
                            array(
                                struct(
                                    lit("configuration/sources/FS_SAP_DC_CUST").alias("type"),
                                    concat(lit("FS_SAP_DC_CUST - "), col("Identifier_ID").cast(StringType()), lit(" -Primary")).alias("value")
                                )
                            ).alias("crosswalks")
                    ).alias("refRelation")
                )
 ...
 # This 'refRelation' was previously duplicated in terms of aliasing
    ...
    prefix = "enriched/FS_SAP_DC_CUST/HCO_SAP_JSON/"  # S3 folder path
...
try:
 ...
 # This 'refRelation' was previously duplicated in terms of aliasing
    ...
    s3_bucket = "adl-base-customer-mdm-etl-dev-226aog"
    prefix = "enriched/FS_SAP_DC_CUST/HCP_SAP_JSON/"  # S3 folder path
